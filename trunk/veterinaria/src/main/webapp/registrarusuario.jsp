...
<div class="inner_copy"><a href="http://www.bestfreetemplates.org/">free templates</a><a href="http://www.bannermoz.com/">banner templates</a></div>
	...
	<div id="wrapper">
		<div class="block">
			<img src="cmn/img/pic.jpg" alt="" width="85" height="93" /><br />
			<form name="form1" method="post" action="">
			  <label><br/>
			  </label>
			  <table width="230" border="0">
                <tr>
                  <td width="220"><label><span class="style6"><span class="style7">Reg&iacute;strate</span><br/>
                  </span></label></td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
	  ...
	  <div id="left">
	    ...
	    <form name="form2" method="post" action="">
          <p class="style10">Crea tu cuenta para acceder y poder publicar tus comentarios, testimonios y anuncios en nuestra web:</p>
          <table width="360" border="0" cellspacing="6">
            <tr>
              <td width="148"><span class="style10">Nombres:</span></td>
              <td width="166"><label>
            ...
            <tr>
              <td width="148"><span class="style10">Apellidos:</span></td>
              <td><label>
            ...
            <tr>
              <td width="148"><span class="style10">DNI:</span></td>
              <td><label>
            ...
            <tr>
              <td width="148"><span class="style10">Direcci&oacute;n:</span></td>
              <td><label>
            ...
            <tr>
              <td width="148"><span class="style10">Tel&eacute;fono:</span></td>
              <td><label>
            ...
            <tr>
              <td width="148"><span class="style10">Celular:</span></td>
              <td><label>
            ...
            <tr>
              <td width="148"><span class="style10">Email:</span></td>
              <td><label>
            ...
            <tr>
              <td width="148"><span class="style10">Contrase&ntilde;a:</span></td>
              <td><label>
            ...
            <tr>
              <td width="148"><span class="style10">Reingresar contrase&ntilde;a: </span></td>
              <td><label>
                <input type="password" name="textfield9">
              </label></td>
              <td>(*)</td>
            </tr>
            <tr>
              <td width="148"><span class="style10">
                <label>
